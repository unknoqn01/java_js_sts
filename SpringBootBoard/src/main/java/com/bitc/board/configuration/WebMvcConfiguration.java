...
//		기본 단위가 byte임, 5 * 1024 * 1024 = 5MB
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		addResourceLocations("file:///C:/Users/1/Desktop/java/java_js_sts/SpringBootBoard/images/");
		
		registry.addResourceHandler("/image/**").
		addResourceLocations("file:///C:/image/");

		registry.addResourceHandler("/webImage/**").
		addResourceLocations("file:///C:/web/images/");
