...
<body>
	...
	<form action="#" method = "get">
		...
		<button type = "button"  id ="btn-idChecR">아이디 중복 검사</button><br>
		...
		<label>성별 : </label>
		<input type = "radio" id ="userGenderM" name = "userGenderM" value = "남자"> 남성
		<input type = "radio" id ="userGenderF" name = "userGenderF" value = "여자"> 여성<br>
 		<label>취미 : </label>
